      ...
      if (hasDeepSeekKey || requiresLlmConfig) {
        providers['crawshrimp-deepseek-official'] = {
          ...
          models: [
            ...
            { id: 'deepseek-v4-pro', contextWindow: 128000, maxTokens: 16384, input: ['text'], reasoningEfforts: { off: null, low: 'low', high: 'high', max: 'max' } },
            { id: 'deepseek-v4-flash-vision-exp', contextWindow: 128000, maxTokens: 8192, input: ['text', 'image'] },
          ],
        }
      }
      if (hasGatewayKey) {
