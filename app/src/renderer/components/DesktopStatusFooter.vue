...
.account-menu{position:fixed;inset:auto;margin:0;box-sizing:border-box;padding:5px;border:1px solid color-mix(in srgb,var(--text) 12%,transparent);border-radius:12px;background:var(--bg2);color:var(--text);box-shadow:0 12px 32px rgb(0 0 0 / .22),0 2px 6px rgb(0 0 0 / .12),inset 0 1px 0 color-mix(in srgb,var(--text) 5%,transparent);overflow-y:auto;overscroll-behavior:contain;font-family:inherit}
