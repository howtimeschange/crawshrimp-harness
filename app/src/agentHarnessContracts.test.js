...
test('agent runtime missing model keys still opens DSH and gates composer with configuration modal', () => {
  ...
  assert.match(webView, /saveInlineLlmSettings/)
  assert.match(webView, /buildLlmSettingsPatch/)
  assert.match(webView, /patchSettings/)
  assert.match(webView, /DeepSeek 官方 API Key/)
  assert.match(webView, /重置或更换 Key/)
